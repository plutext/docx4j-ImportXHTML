...
public class XHTMLImporterImpl implements XHTMLImporter {
    ...
    public List<Object> convert(String content,  String baseUrl) throws Docx4JException {
        ...
        } catch  ( org.xhtmlrenderer.util.XRRuntimeException xre) {
...
//                log.debug(box.getElement().getAttribute("class"));            	
            ...
            if (box instanceof org.xhtmlrenderer.newtable.TableSectionBox) {
            	// ignore, since <table id = ..
            	// generates TableBox<table and TableSectionBox<table
            	// but we only want a single bookmark
            } else if(box instanceof org.xhtmlrenderer.newtable.TableBox) {
...
//                	}            		
            	...
            	} else if (box instanceof org.xhtmlrenderer.newtable.TableSectionBox) {
...
//            		}
		            ...
		            TableBox tableBox = (org.xhtmlrenderer.newtable.TableBox)box;
...
//		    		log.debug("is nested? " + isNested);
            		...
            		// but not instanceof org.xhtmlrenderer.newtable.TableBox
...
//            		}
            	...
            	} else if (box instanceof org.xhtmlrenderer.newtable.TableRowBox) {
...
//            		} 
		            ...
		            tableHelper.setupTrPr((org.xhtmlrenderer.newtable.TableRowBox)box, tr); // does nothing at present
            		
            	} else if (box instanceof org.xhtmlrenderer.newtable.TableCellBox) {
            		...
            		org.xhtmlrenderer.newtable.TableCellBox tcb = (org.xhtmlrenderer.newtable.TableCellBox)box;
		            ...
		            tableHelper.insertDummyVMergedCells(trContext, tcb, false);
            			 ...
            			 */
            			&& !(blockBox instanceof org.xhtmlrenderer.render.AnonymousBlockBox)) {
	...
	private void addImage(BlockBox box) {
		...
		/*
			DocxRenderer {
			    ...
			    // TODO reconcile that with org.xhtmlrenderer.layout.SharedContext
...
//        }
	...
	protected int getLocalIndentation(Styleable styleable) {
		...
		while (o !=null
				...
				&& !(o instanceof org.xhtmlrenderer.newtable.TableCellBox) 
	...
	protected int getAncestorIndentation(Styleable styleable) {
		...
		while (o !=null
				&& o instanceof BlockBox 
				/* && !(o instanceof org.xhtmlrenderer.newtable.TableCellBox) */ //  need to stop if we encounter a table cell? 
				) {
