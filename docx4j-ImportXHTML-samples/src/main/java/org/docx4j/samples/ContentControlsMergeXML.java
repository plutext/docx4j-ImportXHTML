...
public class ContentControlsMergeXML {
	...
	public static void main(String[] args) throws Exception {
		...
		// the docx 'template'
		String input_DOCX = System.getProperty("user.dir") + "/sample-docs/word/databinding/xhtml.docx";
		
		// the instance data
		String input_XML = System.getProperty("user.dir") + "/sample-docs/word/databinding/xhtml-data.xml";
